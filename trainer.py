...
from metrics import accuracy,dc
from typing import NamedTuple, List
from visdom import Visdom
import pandas as pd
from pp.Dice import make_one_hot
...
class trainer(object):
    ...
    def training_phase(self, dataloader):
        ...
        for inputs, targets in dataloader:
            ...
            loss = self.loss_criterion(outputs, make_one_hot(targets.to(self.device), 2))
